...
def convert_text_to_speech(text, output_filename='output.mp3', language='id'):
    """
    Convert Indonesian text to speech using gTTS.
    
    Args:
        text (str): Input text in Indonesian to convert to speech
        output_filename (str, optional): Name of output MP3 file. Defaults to 'output.mp3'
        language (str, optional): Language code. Defaults to 'id' for Indonesian
...
def process_csv_input(csv_filename, language='id'):
    """
    Read Indonesian sentences from a CSV file and convert them to speech.
...
def main():
    """
    Main function to handle CSV-based TTS conversion
    """
    print("🇮🇩 Indonesian Text-to-Speech Converter from CSV 🔊")
